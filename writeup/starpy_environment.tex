...
\begin{figure}
\centering{
\includegraphics[width=0.4\textwidth]{redshift_cent_field.png}
\caption{Redshift distributions of quenching or quenched central galaxies in the \textsc{gz-group} sample (black solid line) in comparison to the redshift and mass matched \textsc{gz-field} sample (blue dashed line).}}
\label{fig:zcompare}
\end{figure}
